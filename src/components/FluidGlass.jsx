...
function Lens({ modeProps, ...p }) {
  return <ModeWrapper glb="/assets/3d/DamagedHelmet.glb" geometryKey="Cylinder" followPointer modeProps={modeProps} {...p} />;
}

function Cube({ modeProps, ...p }) {
  return <ModeWrapper glb="/assets/3d/DamagedHelmet.glb" geometryKey="Cube" followPointer modeProps={modeProps} {...p} />;
}
